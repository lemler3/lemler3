...
yay -S firefox discord steam minecraft-launcher osbuddy runelite obs-studio pamac-aur timeshift thunderbird lutris deluge-gtk gufw runescape-launcher google-chrome cronie --noconfirm && sudo systemctl enable --now cronie && sudo systemctl enable --now ufw
