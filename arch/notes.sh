...
yay -S firefox discord steam minecraft-launcher runelite obs-studio v4l2loopback-dkms pamac-aur  thunderbird lutris deluge-gtk gufw runescape-launcher google-chrome cronie --noconfirm && sudo systemctl enable --now cronie && sudo systemctl enable --now ufw
